...
def evaluate(board):
    ...
    for square, piece in board.piece_map().items():
        if piece.color:
            score += materialValue[partOfTheGame][piece.piece_type - 1]
            score += squareValue[partOfTheGame][piece.piece_type - 1][63 - square]
        else:
            score -= materialValue[partOfTheGame][piece.piece_type - 1]
            score -= squareValue[partOfTheGame][piece.piece_type - 1][square]
